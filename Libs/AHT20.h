...
uint32_t AHT20_Temp(void);                       // Extract temperature from data and return value (Celsius)
uint32_t AHT20_Humid(void);                      // Extract Humidity from data and return value (Percent)
#endif
